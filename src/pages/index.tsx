        ...
        <main className="">
          <div className="text-center">
            ...
            <div className="flex justify-center ">
              <Link href="https://discord.gg/CczE95fWs3" className="py-1.5 px-5 bg-zinc-600 hover:bg-zinc-700 rounded-3xl transition duration-150 text-zinc-300 font-medium mr-2"><FontAwesomeIcon icon={faDiscord} size="sm" />
                discord
                </Link>
